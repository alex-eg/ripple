  ...
  (defun main-loop ()
    (sdl:with-init ()
      ...
      (let ((tex (texture:load-from-file
        ...
        (shader:set-shader blinn #P"./resources/shaders/version-140.frag.glsl" :fragment-shader)
        (shader:set-shader blinn #P"./resources/shaders/version-140.vert.glsl" :vertex-shader)
